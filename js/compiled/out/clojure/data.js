...
return cljs.core.reduce.call(null,(function (result,p__29661){
...
var vec__29665 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__29665,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__29665,(1),null);
var ab = cljs.core.nth.call(null,vec__29665,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_29671 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_29671.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_29672 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_29672.call(null,a,b);
}
});
...
return (function (){var G__29676 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29676__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1619117996378
