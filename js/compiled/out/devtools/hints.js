...
var map__30320 = top_item;
var map__30320__$1 = cljs.core.__destructure_map.call(null,map__30320);
var file = cljs.core.get.call(null,map__30320__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__30320__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__30320__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e30319){var _e = e30319;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___30321 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___30321)){
var seen_errors_30322 = temp__5718__auto___30321;
if(cljs.core.truth_(seen_errors_30322.has(self))){
} else {
seen_errors_30322.add(self);

var temp__5720__auto___30323 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___30323)){
var sense_30324 = temp__5720__auto___30323;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30324)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1619050502142
