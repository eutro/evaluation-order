...
var map__30305 = top_item;
var map__30305__$1 = cljs.core.__destructure_map.call(null,map__30305);
var file = cljs.core.get.call(null,map__30305__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__30305__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__30305__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e30304){var _e = e30304;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___30306 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___30306)){
var seen_errors_30307 = temp__5718__auto___30306;
if(cljs.core.truth_(seen_errors_30307.has(self))){
} else {
seen_errors_30307.add(self);

var temp__5720__auto___30308 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___30308)){
var sense_30309 = temp__5720__auto___30308;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30309)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1619086741494
