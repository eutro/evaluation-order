...
var o27574 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27574["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27575 = temp__5718__auto____$1;
return (o27575["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27496__auto__ = f;
return (o__27496__auto__["toString"]).call(o__27496__auto__);
} else {
return "";
}
...
try{var o__27496__auto___27578 = t;
(o__27496__auto___27578["cljs$lang$ctorPrWriter"]).call(o__27496__auto___27578,t,writer);
}catch (e27577){var __27579 = e27577;
}
...
var char_code = (function (){var o__27496__auto__ = (new String(char$));
return (o__27496__auto__["charCodeAt"]).call(o__27496__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27496__auto__ = String;
return (o__27496__auto__["fromCharCode"]).call(o__27496__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27580 = num_code;
switch (G__27580) {
case (1):
return (185);
...
var o__27496__auto__ = String;
return (o__27496__auto__["fromCharCode"]).call(o__27496__auto__,superscript_code);
});
/**
...
}catch (e27582){var _e__27503__auto__ = e27582;
return false;
}})())){
...
var vec__27583 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27583,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27586 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27586["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27587 = temp__5718__auto____$1;
return (o27587["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4771__auto___27594 = arguments.length;
var i__4772__auto___27595 = (0);
while(true){
if((i__4772__auto___27595 < len__4771__auto___27594)){
args__4777__auto__.push((arguments[i__4772__auto___27595]));

var G__27596 = (i__4772__auto___27595 + (1));
i__4772__auto___27595 = G__27596;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27590){
var vec__27591 = p__27590;
var ns_detector = cljs.core.nth.call(null,vec__27591,(0),null);
...
var G__27597 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27598 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27597;
remaining_tokens = G__27598;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27588){
var G__27589 = cljs.core.first.call(null,seq27588);
var seq27588__$1 = cljs.core.next.call(null,seq27588);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27589,seq27588__$1);
}));
...
var vec__27602 = cljs.core.split_with.call(null,(function (p1__27601_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27601_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27602,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27602,(1),null);
...
var vec__27608 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27608,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27608,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27611 = cljs.core.rest.call(null,remaining_tokens);
var G__27612 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27611;
name_tokens = G__27612;
continue;
} else {
...
var vec__27615 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27615,(0),null);
var arity = cljs.core.nth.call(null,vec__27615,(1),null);
var vec__27618 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27618,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27618,(1),null);
var vec__27621 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27621,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27621,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27621,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27621,(3),null);
...
var vec__27627 = result;
var munged_ns = cljs.core.nth.call(null,vec__27627,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27627,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27627,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27627,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27627,(4),null);
var arity = cljs.core.nth.call(null,vec__27627,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27631 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27631,(0),null);
var args = cljs.core.nth.call(null,vec__27631,(1),null);
var vec__27634 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27634,(0),null);
var name = cljs.core.nth.call(null,vec__27634,(1),null);
...
var G__27637 = (arity + (1));
var G__27638 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27639){
var vec__27640 = p__27639;
var arity = cljs.core.nth.call(null,vec__27640,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27640,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27643_SHARP_){
return cljs.core.get.call(null,arities,p1__27643_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27644_SHARP_){
return cljs.core.drop.call(null,(2),p1__27644_SHARP_);
}),sorted_infos);
...
var args__4777__auto__ = [];
var len__4771__auto___27651 = arguments.length;
var i__4772__auto___27652 = (0);
while(true){
if((i__4772__auto___27652 < len__4771__auto___27651)){
args__4777__auto__.push((arguments[i__4772__auto___27652]));

var G__27653 = (i__4772__auto___27652 + (1));
i__4772__auto___27652 = G__27653;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27647){
var vec__27648 = p__27647;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27648,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27645){
var G__27646 = cljs.core.first.call(null,seq27645);
var seq27645__$1 = cljs.core.next.call(null,seq27645);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27646,seq27645__$1);
}));
...
var map__27656 = options;
var map__27656__$1 = cljs.core.__destructure_map.call(null,map__27656);
var include_ns_QMARK_ = cljs.core.get.call(null,map__27656__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27656__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27656__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27656__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27657 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27657,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27657,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27657,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27657,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27657,(4),null);
var arity = cljs.core.nth.call(null,vec__27657,(5),null);
...
var o__27496__auto__ = f;
return (o__27496__auto__["getBasis"]).call(o__27496__auto__);
});
/**
...
}catch (e27660){var _e__27503__auto__ = e27660;
...
var G__27661 = (obj[cljs.core.first.call(null,path)]);
var G__27662 = cljs.core.rest.call(null,path);
obj = G__27661;
path = G__27662;
continue;
} else {
...
var _STAR_ = (function (accum,p__27663){
var vec__27664 = p__27663;
var bit = cljs.core.nth.call(null,vec__27664,(0),null);
var protocol = cljs.core.nth.call(null,vec__27664,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27667){
var vec__27668 = p__27667;
var ns = cljs.core.nth.call(null,vec__27668,(0),null);
var name = cljs.core.nth.call(null,vec__27668,(1),null);
var selector = cljs.core.nth.call(null,vec__27668,(2),null);
...
var post_process = (function (p__27672){
var vec__27673 = p__27672;
var munged_name = cljs.core.nth.call(null,vec__27673,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27673,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27671_SHARP_){
return (obj[cljs.core.first.call(null,p1__27671_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1618926906982
