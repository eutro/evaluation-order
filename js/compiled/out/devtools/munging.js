...
var o27556 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27556["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27557 = temp__5718__auto____$1;
return (o27557["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27478__auto__ = f;
return (o__27478__auto__["toString"]).call(o__27478__auto__);
} else {
return "";
}
}catch (e27558){var _ = e27558;
return "";
}});
...
try{var o__27478__auto___27560 = t;
(o__27478__auto___27560["cljs$lang$ctorPrWriter"]).call(o__27478__auto___27560,t,writer);
}catch (e27559){var __27561 = e27559;
}
...
var char_code = (function (){var o__27478__auto__ = (new String(char$));
return (o__27478__auto__["charCodeAt"]).call(o__27478__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27478__auto__ = String;
return (o__27478__auto__["fromCharCode"]).call(o__27478__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27562 = num_code;
switch (G__27562) {
case (1):
return (185);
...
var o__27478__auto__ = String;
return (o__27478__auto__["fromCharCode"]).call(o__27478__auto__,superscript_code);
});
/**
...
}catch (e27564){var _e__27485__auto__ = e27564;
return false;
}})())){
...
var vec__27565 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27565,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27568 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27568["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27569 = temp__5718__auto____$1;
return (o27569["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4771__auto___27576 = arguments.length;
var i__4772__auto___27577 = (0);
while(true){
if((i__4772__auto___27577 < len__4771__auto___27576)){
args__4777__auto__.push((arguments[i__4772__auto___27577]));

var G__27578 = (i__4772__auto___27577 + (1));
i__4772__auto___27577 = G__27578;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27572){
var vec__27573 = p__27572;
var ns_detector = cljs.core.nth.call(null,vec__27573,(0),null);
...
var G__27579 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27580 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27579;
remaining_tokens = G__27580;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27570){
var G__27571 = cljs.core.first.call(null,seq27570);
var seq27570__$1 = cljs.core.next.call(null,seq27570);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27571,seq27570__$1);
}));
...
var vec__27584 = cljs.core.split_with.call(null,(function (p1__27583_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27583_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27584,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27584,(1),null);
...
var vec__27590 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27590,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27590,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27593 = cljs.core.rest.call(null,remaining_tokens);
var G__27594 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27593;
name_tokens = G__27594;
continue;
} else {
...
var vec__27597 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27597,(0),null);
var arity = cljs.core.nth.call(null,vec__27597,(1),null);
var vec__27600 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27600,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27600,(1),null);
var vec__27603 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27603,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27603,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27603,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27603,(3),null);
...
var vec__27609 = result;
var munged_ns = cljs.core.nth.call(null,vec__27609,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27609,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27609,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27609,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27609,(4),null);
var arity = cljs.core.nth.call(null,vec__27609,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27613 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27613,(0),null);
var args = cljs.core.nth.call(null,vec__27613,(1),null);
var vec__27616 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27616,(0),null);
var name = cljs.core.nth.call(null,vec__27616,(1),null);
...
var G__27619 = (arity + (1));
var G__27620 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27621){
var vec__27622 = p__27621;
var arity = cljs.core.nth.call(null,vec__27622,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27622,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27625_SHARP_){
return cljs.core.get.call(null,arities,p1__27625_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27626_SHARP_){
return cljs.core.drop.call(null,(2),p1__27626_SHARP_);
}),sorted_infos);
...
var args__4777__auto__ = [];
var len__4771__auto___27633 = arguments.length;
var i__4772__auto___27634 = (0);
while(true){
if((i__4772__auto___27634 < len__4771__auto___27633)){
args__4777__auto__.push((arguments[i__4772__auto___27634]));

var G__27635 = (i__4772__auto___27634 + (1));
i__4772__auto___27634 = G__27635;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27629){
var vec__27630 = p__27629;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27630,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27627){
var G__27628 = cljs.core.first.call(null,seq27627);
var seq27627__$1 = cljs.core.next.call(null,seq27627);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27628,seq27627__$1);
}));
...
var map__27638 = options;
var map__27638__$1 = cljs.core.__destructure_map.call(null,map__27638);
var include_ns_QMARK_ = cljs.core.get.call(null,map__27638__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27638__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27638__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27638__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27639 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27639,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27639,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27639,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27639,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27639,(4),null);
var arity = cljs.core.nth.call(null,vec__27639,(5),null);
...
var o__27478__auto__ = f;
return (o__27478__auto__["getBasis"]).call(o__27478__auto__);
});
/**
...
}catch (e27642){var _e__27485__auto__ = e27642;
...
var G__27643 = (obj[cljs.core.first.call(null,path)]);
var G__27644 = cljs.core.rest.call(null,path);
obj = G__27643;
path = G__27644;
continue;
} else {
...
var _STAR_ = (function (accum,p__27645){
var vec__27646 = p__27645;
var bit = cljs.core.nth.call(null,vec__27646,(0),null);
var protocol = cljs.core.nth.call(null,vec__27646,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27649){
var vec__27650 = p__27649;
var ns = cljs.core.nth.call(null,vec__27650,(0),null);
var name = cljs.core.nth.call(null,vec__27650,(1),null);
var selector = cljs.core.nth.call(null,vec__27650,(2),null);
...
var post_process = (function (p__27654){
var vec__27655 = p__27654;
var munged_name = cljs.core.nth.call(null,vec__27655,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27655,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27653_SHARP_){
return (obj[cljs.core.first.call(null,p1__27653_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1618871561421
