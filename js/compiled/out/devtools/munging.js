...
var o24417 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24417["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24418 = temp__5718__auto____$1;
return (o24418["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24339__auto__ = f;
return (o__24339__auto__["toString"]).call(o__24339__auto__);
} else {
return "";
}
}catch (e24419){var _ = e24419;
return "";
}});
...
try{var o__24339__auto___24421 = t;
(o__24339__auto___24421["cljs$lang$ctorPrWriter"]).call(o__24339__auto___24421,t,writer);
}catch (e24420){var __24422 = e24420;
}
...
var char_code = (function (){var o__24339__auto__ = (new String(char$));
return (o__24339__auto__["charCodeAt"]).call(o__24339__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24339__auto__ = String;
return (o__24339__auto__["fromCharCode"]).call(o__24339__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24423 = num_code;
switch (G__24423) {
case (1):
return (185);
...
var o__24339__auto__ = String;
return (o__24339__auto__["fromCharCode"]).call(o__24339__auto__,superscript_code);
});
/**
...
}catch (e24425){var _e__24346__auto__ = e24425;
return false;
}})())){
...
var vec__24426 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24426,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o24429 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24429["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24430 = temp__5718__auto____$1;
return (o24430["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24433){
var vec__24434 = p__24433;
var ns_detector = cljs.core.nth.call(null,vec__24434,(0),null);
...
var G__24440 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24441 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24440;
remaining_tokens = G__24441;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24431){
...
var vec__24445 = cljs.core.split_with.call(null,(function (p1__24444_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24444_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24445,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24445,(1),null);
...
var vec__24451 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24451,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24451,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24454 = cljs.core.rest.call(null,remaining_tokens);
var G__24455 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24454;
name_tokens = G__24455;
continue;
} else {
...
var vec__24458 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24458,(0),null);
var arity = cljs.core.nth.call(null,vec__24458,(1),null);
var vec__24461 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24461,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24461,(1),null);
var vec__24464 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24464,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24464,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24464,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24464,(3),null);
...
var vec__24470 = result;
var munged_ns = cljs.core.nth.call(null,vec__24470,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24470,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24470,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24470,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24470,(4),null);
var arity = cljs.core.nth.call(null,vec__24470,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__24474 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__24474,(0),null);
var args = cljs.core.nth.call(null,vec__24474,(1),null);
var vec__24477 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24477,(0),null);
var name = cljs.core.nth.call(null,vec__24477,(1),null);
...
var G__24480 = (arity + (1));
var G__24481 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24482){
var vec__24483 = p__24482;
var arity = cljs.core.nth.call(null,vec__24483,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24483,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24486_SHARP_){
return cljs.core.get.call(null,arities,p1__24486_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__24487_SHARP_){
return cljs.core.drop.call(null,(2),p1__24487_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___24494 = arguments.length;
var i__4737__auto___24495 = (0);
while(true){
if((i__4737__auto___24495 < len__4736__auto___24494)){
args__4742__auto__.push((arguments[i__4737__auto___24495]));

var G__24496 = (i__4737__auto___24495 + (1));
i__4737__auto___24495 = G__24496;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24490){
var vec__24491 = p__24490;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24491,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24488){
var G__24489 = cljs.core.first.call(null,seq24488);
var seq24488__$1 = cljs.core.next.call(null,seq24488);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24489,seq24488__$1);
}));
...
var G__24497 = arg;
var G__24497__$1 = (((G__24497 instanceof cljs.core.Keyword))?G__24497.fqn:null);
switch (G__24497__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24499__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24499__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24499__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24499__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24500 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24500,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24500,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24500,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24500,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24500,(4),null);
var arity = cljs.core.nth.call(null,vec__24500,(5),null);
...
var o__24339__auto__ = f;
return (o__24339__auto__["getBasis"]).call(o__24339__auto__);
});
/**
...
}catch (e24504){var _e__24346__auto__ = e24504;
...
var G__24505 = (obj[cljs.core.first.call(null,path)]);
var G__24506 = cljs.core.rest.call(null,path);
obj = G__24505;
path = G__24506;
continue;
} else {
...
var _STAR_ = (function (accum,p__24507){
var vec__24508 = p__24507;
var bit = cljs.core.nth.call(null,vec__24508,(0),null);
var protocol = cljs.core.nth.call(null,vec__24508,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24511){
var vec__24512 = p__24511;
var ns = cljs.core.nth.call(null,vec__24512,(0),null);
var name = cljs.core.nth.call(null,vec__24512,(1),null);
var selector = cljs.core.nth.call(null,vec__24512,(2),null);
...
var post_process = (function (p__24516){
var vec__24517 = p__24516;
var munged_name = cljs.core.nth.call(null,vec__24517,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24517,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24515_SHARP_){
return (obj[cljs.core.first.call(null,p1__24515_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1618736709945
