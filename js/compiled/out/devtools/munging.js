...
var o24458 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24458["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24459 = temp__5718__auto____$1;
return (o24459["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24380__auto__ = f;
return (o__24380__auto__["toString"]).call(o__24380__auto__);
} else {
return "";
}
}catch (e24460){var _ = e24460;
return "";
}});
...
try{var o__24380__auto___24462 = t;
(o__24380__auto___24462["cljs$lang$ctorPrWriter"]).call(o__24380__auto___24462,t,writer);
}catch (e24461){var __24463 = e24461;
}
...
var char_code = (function (){var o__24380__auto__ = (new String(char$));
return (o__24380__auto__["charCodeAt"]).call(o__24380__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24380__auto__ = String;
return (o__24380__auto__["fromCharCode"]).call(o__24380__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24464 = num_code;
switch (G__24464) {
case (1):
return (185);
...
var o__24380__auto__ = String;
return (o__24380__auto__["fromCharCode"]).call(o__24380__auto__,superscript_code);
});
/**
...
}catch (e24466){var _e__24387__auto__ = e24466;
return false;
}})())){
...
var vec__24467 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24467,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o24470 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24470["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24471 = temp__5718__auto____$1;
return (o24471["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___24478 = arguments.length;
var i__4737__auto___24479 = (0);
while(true){
if((i__4737__auto___24479 < len__4736__auto___24478)){
args__4742__auto__.push((arguments[i__4737__auto___24479]));

var G__24480 = (i__4737__auto___24479 + (1));
i__4737__auto___24479 = G__24480;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24474){
var vec__24475 = p__24474;
var ns_detector = cljs.core.nth.call(null,vec__24475,(0),null);
...
var G__24481 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24482 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24481;
remaining_tokens = G__24482;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24472){
var G__24473 = cljs.core.first.call(null,seq24472);
var seq24472__$1 = cljs.core.next.call(null,seq24472);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24473,seq24472__$1);
}));
...
var vec__24486 = cljs.core.split_with.call(null,(function (p1__24485_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24485_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24486,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24486,(1),null);
...
var vec__24492 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24492,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24492,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24495 = cljs.core.rest.call(null,remaining_tokens);
var G__24496 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24495;
name_tokens = G__24496;
continue;
} else {
...
var vec__24499 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24499,(0),null);
var arity = cljs.core.nth.call(null,vec__24499,(1),null);
var vec__24502 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24502,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24502,(1),null);
var vec__24505 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24505,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24505,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24505,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24505,(3),null);
...
var vec__24511 = result;
var munged_ns = cljs.core.nth.call(null,vec__24511,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24511,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24511,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24511,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24511,(4),null);
var arity = cljs.core.nth.call(null,vec__24511,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__24515 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__24515,(0),null);
var args = cljs.core.nth.call(null,vec__24515,(1),null);
var vec__24518 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24518,(0),null);
var name = cljs.core.nth.call(null,vec__24518,(1),null);
...
var G__24521 = (arity + (1));
var G__24522 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24523){
var vec__24524 = p__24523;
var arity = cljs.core.nth.call(null,vec__24524,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24524,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24527_SHARP_){
return cljs.core.get.call(null,arities,p1__24527_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__24528_SHARP_){
return cljs.core.drop.call(null,(2),p1__24528_SHARP_);
}),sorted_infos);
...
args__4742__auto__.push((arguments[i__4737__auto___24536]));
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24531){
var vec__24532 = p__24531;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24532,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24529){
var G__24530 = cljs.core.first.call(null,seq24529);
var seq24529__$1 = cljs.core.next.call(null,seq24529);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24530,seq24529__$1);
}));
...
var G__24538 = arg;
var G__24538__$1 = (((G__24538 instanceof cljs.core.Keyword))?G__24538.fqn:null);
switch (G__24538__$1) {
...
var map__24540 = options;
var map__24540__$1 = (((((!((map__24540 == null))))?(((((map__24540.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24540.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24540):map__24540);
var include_ns_QMARK_ = cljs.core.get.call(null,map__24540__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24540__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24540__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24540__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24541 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24541,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24541,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24541,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24541,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24541,(4),null);
var arity = cljs.core.nth.call(null,vec__24541,(5),null);
...
var o__24380__auto__ = f;
return (o__24380__auto__["getBasis"]).call(o__24380__auto__);
});
/**
...
}catch (e24545){var _e__24387__auto__ = e24545;
...
var G__24546 = (obj[cljs.core.first.call(null,path)]);
var G__24547 = cljs.core.rest.call(null,path);
obj = G__24546;
path = G__24547;
continue;
} else {
...
var _STAR_ = (function (accum,p__24548){
var vec__24549 = p__24548;
var bit = cljs.core.nth.call(null,vec__24549,(0),null);
var protocol = cljs.core.nth.call(null,vec__24549,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24552){
var vec__24553 = p__24552;
var ns = cljs.core.nth.call(null,vec__24553,(0),null);
var name = cljs.core.nth.call(null,vec__24553,(1),null);
var selector = cljs.core.nth.call(null,vec__24553,(2),null);
...
var post_process = (function (p__24557){
var vec__24558 = p__24557;
var munged_name = cljs.core.nth.call(null,vec__24558,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24558,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24556_SHARP_){
return (obj[cljs.core.first.call(null,p1__24556_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1618749920176
