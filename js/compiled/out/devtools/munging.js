...
var o27572 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27572["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27573 = temp__5718__auto____$1;
return (o27573["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27494__auto__ = f;
return (o__27494__auto__["toString"]).call(o__27494__auto__);
} else {
return "";
}
}catch (e27574){var _ = e27574;
return "";
}});
...
try{var o__27494__auto___27576 = t;
(o__27494__auto___27576["cljs$lang$ctorPrWriter"]).call(o__27494__auto___27576,t,writer);
}catch (e27575){var __27577 = e27575;
}
...
var char_code = (function (){var o__27494__auto__ = (new String(char$));
return (o__27494__auto__["charCodeAt"]).call(o__27494__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27494__auto__ = String;
return (o__27494__auto__["fromCharCode"]).call(o__27494__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27578 = num_code;
switch (G__27578) {
case (1):
return (185);
...
var o__27494__auto__ = String;
return (o__27494__auto__["fromCharCode"]).call(o__27494__auto__,superscript_code);
});
/**
...
}catch (e27580){var _e__27501__auto__ = e27580;
return false;
}})())){
...
var vec__27581 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27581,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27584 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27584["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27585 = temp__5718__auto____$1;
return (o27585["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4771__auto___27592 = arguments.length;
var i__4772__auto___27593 = (0);
while(true){
if((i__4772__auto___27593 < len__4771__auto___27592)){
args__4777__auto__.push((arguments[i__4772__auto___27593]));

var G__27594 = (i__4772__auto___27593 + (1));
i__4772__auto___27593 = G__27594;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27588){
var vec__27589 = p__27588;
var ns_detector = cljs.core.nth.call(null,vec__27589,(0),null);
...
var G__27595 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27596 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27595;
remaining_tokens = G__27596;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27586){
var G__27587 = cljs.core.first.call(null,seq27586);
var seq27586__$1 = cljs.core.next.call(null,seq27586);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27587,seq27586__$1);
}));
...
var vec__27600 = cljs.core.split_with.call(null,(function (p1__27599_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27599_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27600,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27600,(1),null);
...
var vec__27606 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27606,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27606,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27609 = cljs.core.rest.call(null,remaining_tokens);
var G__27610 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27609;
name_tokens = G__27610;
continue;
} else {
...
var vec__27613 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27613,(0),null);
var arity = cljs.core.nth.call(null,vec__27613,(1),null);
var vec__27616 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27616,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27616,(1),null);
var vec__27619 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27619,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27619,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27619,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27619,(3),null);
...
var vec__27625 = result;
var munged_ns = cljs.core.nth.call(null,vec__27625,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27625,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27625,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27625,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27625,(4),null);
var arity = cljs.core.nth.call(null,vec__27625,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27629 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27629,(0),null);
var args = cljs.core.nth.call(null,vec__27629,(1),null);
var vec__27632 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27632,(0),null);
var name = cljs.core.nth.call(null,vec__27632,(1),null);
...
var G__27635 = (arity + (1));
var G__27636 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27637){
var vec__27638 = p__27637;
var arity = cljs.core.nth.call(null,vec__27638,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27638,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27641_SHARP_){
return cljs.core.get.call(null,arities,p1__27641_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27642_SHARP_){
return cljs.core.drop.call(null,(2),p1__27642_SHARP_);
}),sorted_infos);
...
var args__4777__auto__ = [];
var len__4771__auto___27649 = arguments.length;
var i__4772__auto___27650 = (0);
while(true){
if((i__4772__auto___27650 < len__4771__auto___27649)){
args__4777__auto__.push((arguments[i__4772__auto___27650]));

var G__27651 = (i__4772__auto___27650 + (1));
i__4772__auto___27650 = G__27651;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27645){
var vec__27646 = p__27645;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27646,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27643){
var G__27644 = cljs.core.first.call(null,seq27643);
var seq27643__$1 = cljs.core.next.call(null,seq27643);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27644,seq27643__$1);
}));
...
var map__27654 = options;
var map__27654__$1 = cljs.core.__destructure_map.call(null,map__27654);
var include_ns_QMARK_ = cljs.core.get.call(null,map__27654__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27654__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27654__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27654__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27655 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27655,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27655,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27655,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27655,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27655,(4),null);
var arity = cljs.core.nth.call(null,vec__27655,(5),null);
...
var o__27494__auto__ = f;
return (o__27494__auto__["getBasis"]).call(o__27494__auto__);
});
/**
...
}catch (e27658){var _e__27501__auto__ = e27658;
...
var G__27659 = (obj[cljs.core.first.call(null,path)]);
var G__27660 = cljs.core.rest.call(null,path);
obj = G__27659;
path = G__27660;
continue;
} else {
...
var _STAR_ = (function (accum,p__27661){
var vec__27662 = p__27661;
var bit = cljs.core.nth.call(null,vec__27662,(0),null);
var protocol = cljs.core.nth.call(null,vec__27662,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27665){
var vec__27666 = p__27665;
var ns = cljs.core.nth.call(null,vec__27666,(0),null);
var name = cljs.core.nth.call(null,vec__27666,(1),null);
var selector = cljs.core.nth.call(null,vec__27666,(2),null);
...
var post_process = (function (p__27670){
var vec__27671 = p__27670;
var munged_name = cljs.core.nth.call(null,vec__27671,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27671,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27669_SHARP_){
return (obj[cljs.core.first.call(null,p1__27669_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1618911414983
