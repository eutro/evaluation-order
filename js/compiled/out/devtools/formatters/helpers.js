...
var G__28245 = devtools.prefs.pref.call(null,v);
v = G__28245;
continue;
} else {
return v;
...
}catch (e28248){var _e__27501__auto__ = e28248;
return false;
}})();
...
}catch (e28252){var _e__27501__auto__ = e28252;
return false;
}})();
...
}catch (e28254){var _e__27501__auto__ = e28254;
return false;
}}
}
});
...
var vec__28256 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28256,(0),null);
var name = cljs.core.nth.call(null,vec__28256,(1),null);
...
return cljs.core.some.call(null,(function (p1__28259_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28259_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1618911415450
