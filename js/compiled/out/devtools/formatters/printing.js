...
var len__4771__auto___28341 = arguments.length;
var i__4772__auto___28342 = (0);
while(true){
if((i__4772__auto___28342 < len__4771__auto___28341)){
args__4777__auto__.push((arguments[i__4772__auto___28342]));

var G__28343 = (i__4772__auto___28342 + (1));
i__4772__auto___28342 = G__28343;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28338){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28339,G__28340,seq28338__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28344_SHARP_){
return (!((cljs.core.meta.call(null,p1__28344_SHARP_) == null)));
})))){
...
var map__28345 = opts;
var map__28345__$1 = cljs.core.__destructure_map.call(null,map__28345);
var markup_db = cljs.core.get.call(null,map__28345__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28348){var _e__27568__auto__ = e28348;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e28350){var _e__27568__auto__ = e28350;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28352 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28353 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28353);

try{var map__28354 = opts;
var map__28354__$1 = cljs.core.__destructure_map.call(null,map__28354);
var markup_db = cljs.core.get.call(null,map__28354__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28352);
}});
...
var temp__5718__auto___28358 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___28358)){
var managed_print_level_28359 = temp__5718__auto___28358;
var _STAR_print_level_STAR__orig_val__28356_28360 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28357_28361 = managed_print_level_28359;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28357_28361);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__28355_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__28355_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28356_28360);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1619127700476
