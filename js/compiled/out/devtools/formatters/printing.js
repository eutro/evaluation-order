...
var len__4771__auto___28334 = arguments.length;
var i__4772__auto___28335 = (0);
while(true){
if((i__4772__auto___28335 < len__4771__auto___28334)){
args__4777__auto__.push((arguments[i__4772__auto___28335]));

var G__28336 = (i__4772__auto___28335 + (1));
i__4772__auto___28335 = G__28336;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28331){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28332,G__28333,seq28331__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28337_SHARP_){
return (!((cljs.core.meta.call(null,p1__28337_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__28338__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28341){var _e__27561__auto__ = e28341;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e28343){var _e__27561__auto__ = e28343;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28345 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28346 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28346);

try{var map__28347 = opts;
var map__28347__$1 = cljs.core.__destructure_map.call(null,map__28347);
var markup_db = cljs.core.get.call(null,map__28347__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28345);
}});
...
var temp__5718__auto___28351 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___28351)){
var managed_print_level_28352 = temp__5718__auto___28351;
var _STAR_print_level_STAR__orig_val__28349_28353 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28350_28354 = managed_print_level_28352;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28350_28354);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__28348_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__28348_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28349_28353);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1619125858673
