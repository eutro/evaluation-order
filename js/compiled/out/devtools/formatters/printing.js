...
var len__4771__auto___28351 = arguments.length;
var i__4772__auto___28352 = (0);
while(true){
if((i__4772__auto___28352 < len__4771__auto___28351)){
args__4777__auto__.push((arguments[i__4772__auto___28352]));

var G__28353 = (i__4772__auto___28352 + (1));
i__4772__auto___28352 = G__28353;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28348){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28349,G__28350,seq28348__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28354_SHARP_){
return (!((cljs.core.meta.call(null,p1__28354_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__28355__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28358){var _e__27578__auto__ = e28358;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e28360){var _e__27578__auto__ = e28360;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28362 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28363 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28363);

try{var map__28364 = opts;
var map__28364__$1 = cljs.core.__destructure_map.call(null,map__28364);
var markup_db = cljs.core.get.call(null,map__28364__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28362);
}});
...
var temp__5718__auto___28368 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___28368)){
var managed_print_level_28369 = temp__5718__auto___28368;
var _STAR_print_level_STAR__orig_val__28366_28370 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28367_28371 = managed_print_level_28369;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28367_28371);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__28365_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__28365_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28366_28370);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1619050499320
